             ...
             if ($xml = simplexml_load_file($dir . $file)) {
                ...
                if(!xml_child_exists($xml, "//iati-organisation"))  { //exclude organisation files
                    ...
                    foreach ($activities as $activity) {
                      ...
                      $activity_count++;
                      $colab_types = $activity->{'collaboration-type'};
                      //print_r($colab_types);
                      if ($colab_types !=NULL){
                        if (isset($colab_types->attributes()->code)) {
                          $codes[] = $colab_types->attributes()->code;
                        }
                      }
//die;
